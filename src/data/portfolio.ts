...
export const profile = {
  ...
  resumeUrl: `${import.meta.env.BASE_URL}vipul-nikam-resume-2026-july.pdf`,
  imageUrl: `${import.meta.env.BASE_URL}profile-pic.png`,
  avatarUrl: `${import.meta.env.BASE_URL}avatar-3d-display.jpg`,
