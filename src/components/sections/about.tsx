          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {focusAreas.map((area, index) => (
              <Reveal key={area.title} delay={index * 0.06}>
                <article className="group h-full rounded-lg border border-border/70 bg-card/70 p-6 shadow-sm backdrop-blur transition hover:-translate-y-1 hover:border-primary/40 hover:shadow-[0_24px_80px_hsl(var(--primary)/0.12)]">
                  ...
                  <h3 className="font-display text-xl font-semibold text-foreground">{area.title}</h3>
